...
test("operator manages evidence, findings, and immutable case chronology", async ({ page }) => {
  ...
  await expect(page.getByRole("heading", { name: "Investigation timeline" })).toBeVisible();
  await expect(page.getByText("Investigation created.")).toBeVisible();
  await expect(page.getByText("Generated by TRACE").first()).toBeVisible();
  ...
  await expect(page.getByText("Evidence signin-log-001 added.")).toBeVisible();
  ...
  await expect(page.getByText("Evidence signin-log-001 validated.")).toBeVisible();
  ...
  await expect(page.getByText("Redacted escalation context confirmed with the application owner.")).toBeVisible();
  await expect(page.getByText("Authored by Rafael")).toBeVisible();
  ...
  await expect(page.getByText("Analysis run 1 completed.")).toBeVisible();
